...
export const SYSTEM_PROMPT_IDS = {
  ...
  CURRICULUM_EXTRACTION_MULTIPLE_YEAR: 1009,
  CURRICULUM_EXTRACTION_YEARLY: 1010,
  CURRICULUM_EXTRACTION_FULL_TERM: 1011,
  CURRICULUM_EXTRACTION_HALF_TERM: 1012,
...
export const SYSTEM_PROMPT_NAMES = {
  ...
  [SYSTEM_PROMPT_IDS.CURRICULUM_EXTRACTION_YEARLY]: 'Curriculum Extraction (Yearly)',
  [SYSTEM_PROMPT_IDS.CURRICULUM_EXTRACTION_FULL_TERM]: 'Curriculum Extraction (Full Term)',
  [SYSTEM_PROMPT_IDS.CURRICULUM_EXTRACTION_HALF_TERM]: 'Curriculum Extraction (Half Term)',
